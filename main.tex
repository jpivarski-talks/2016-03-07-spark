...
% : this works, but I have concerns about its efficiency for non-local files (e.g. xrootd). Will be featured in a performance study when the other methods are ready.
